    ...
    <div className="px-4 mb-6">
      <div className="border-2 border-[#f6921b] rounded-2xl p-4 bg-[#f6921b]/5">
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
              ...
              {showCurrencyDropdown && (
                <div className="absolute z-10 mt-2 bg-gray-900 border border-gray-600 rounded-lg w-full">
                  {currencies.map((item) => (
                    ...
                    >
                      <img src={Usdt} alt='usdt' className='w-7 h-7'/>{item}
                    </div>
                  ))}
                </div>
              )}
          ...
          {/* Network Dropdown */}
          <div>
            <label className="block text-gray-300 text-sm font-medium mb-2">Choose Coin Network</label>
            <div className="relative">
              <div
      ...
      <div className="bg-[#f6921b]/10 rounded-xl px-2 py-3 border border-[#f6921b]/30">
        <div className="flex items-center space-x-3">
          ...
          <div className="text-xs">
            <span className="text-white font-bold">Get extra </span>
            <span className="text-green-500 font-bold text-sm">5%</span>
            <span className="text-white font-bold"> bonus on minimum of </span>
            <span className="text-green-500 font-bold text-sm">10 USDT</span>
      ...
      <div className="flex-1">
        <div className="flex flex-col items-start gap-2 p-3">
          <div className="bg-gray-800 text-white text-sm break-words">
            <span className="font-mono text-[16px] text-[#f6921b]">{depositAddress}</span>
          </div>
          <div
            onClick={handleCopy}
          ...
          <div className="border-2 border-green-500 bg-green-500/10 flex items-center gap-3 rounded-lg p-3  ">
            <IoMdInformationCircleOutline className="text-green-500" size={20}/>
            <span>Send only <span className="font-semibold text-green-500">USDT</span> to this deposit address</span>
          </div>
        </div>
        {showToast && (
