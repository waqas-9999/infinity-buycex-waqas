        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              >
                Develop and Earn <span style={{ color: "#efb81c" }}>Rewards</span>
              </motion.span>
            </motion.h2>
            ...
            >
              BuyCex Infinity Chain encourages project teams to develop and grow their projects here, with opportunities for
              rewards. Build the future of decentralized finance with our cutting-edge infrastructure.
            </motion.p>
            ...
            >
              {[
                { icon: Code, text: "Developer-friendly tools and APIs" },
                { icon: Coins, text: "Reward programs for active builders" },
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: "#efb81c20" }}
                  >
                    <feature.icon className="w-4 h-4" style={{ color: "#efb81c" }} />
                  </div>
                  ...
                  <div className="relative w-full h-full bg-gradient-to-br from-gray-900 to-black p-6">
                    ...
                    <motion.div
                      ...
                      animate={
                        isInView
                          ? {
                              borderColor: ["rgba(255,255,255,0.3)", "#efb81c80", "rgba(255,255,255,0.3)"],
                            }
                          : {}
                      }
                      transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut", delay: 4 }}
                    >
                      <span className="text-white/50 text-sm font-mono">Deploy Contract</span>
                    </motion.div>
