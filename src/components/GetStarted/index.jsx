...
export default function DeveloperPage() {
    ...
    const startNowCards = [
        {
            ...
            title: "Documentation",
            description:
                "Complete guides and API references to get you started quickly",
            href: "#",
            color: "#3b82f6",
        },
        {
            ...
            title: "GitHub",
            description:
                "Access our open-source repositories and contribute to the ecosystem",
        ...
        },
        {
            ...
            description:
                "Apply for grants and funding to build on BCX Infinity",
            href: "#",
            color: "#efb81c",
        },
    ];
    ...
    const resourceCards = [
        ...
        },
        {
            ...
            title: "API Endpoints",
            description:
                "RESTful APIs and GraphQL endpoints for blockchain data",
            features: [
                "Real-time data",
                "Historical queries",
                "WebSocket support",
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-6 sm:gap-16 items-center">
                        ...
                        >
                            ...
                            >
                                From idea to impact — build, deploy, and scale
                                with BCX Infinity. Unlock the
                                potential of new horizons
                            </motion.p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Supercharge your development journey with{" "}
                            ...
                            >
                                BCX Infinity empowers developers with EVM
                                compatibility, Cosmos interoperability, and
                                lightning-fast performance. Whether you're
                                building DeFi protocols, NFT platforms, or
                                cross-chain dApps, our robust SDKs, APIs, and
                                tooling make development seamless and scalable.
                            </motion.p>
                                    ...
                                    >
                                        <div className="text-white/90">
                                            ...
                                            <span className="text-purple-400">
                                                streamDerivativeMarketOrderbook
                                            </span>{" "}
                                ...
                                <div className="relative h-full bg-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-4 sm:p-8 transition-all duration-300 group-hover:border-gray-600/70 group-hover:bg-gray-900/80 flex flex-col justify-between">
                                    <div>
                                        ...
                                        <p className="text-white/70 text-sm sm:text-lg leading-relaxed mb-6">
                                            ...
                                            building on BCX Infinity today.
                                        </p>
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    ...
                    >
                        {[
                            ...
                            { name: "Twitter", icon: "🐦", href: "https://x.com/bcxinfinity?s=21" },
                            ...
                            { name: "Telegram", icon: "✈️", href: "https://t.me/bcxinfinity" },
                        ].map((social, index) => (
                            <motion.a
                                key={social.name}
                                href={social.href}
