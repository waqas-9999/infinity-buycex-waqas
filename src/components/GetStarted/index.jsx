...
export default function DeveloperPage() {
  ...
  const startNowCards = [
    ...
    },
    {
      ...
      description: "Apply for grants and funding to build on BuyCex",
      href: "#",
      color: "#efb81c",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                With BuyCex's developer documentation, tools, and various resources, quickly build your project on
                BuyCex.
              </motion.p>
              ...
              >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <button
                    size="lg"
                    className="text-black flex items-center font-semibold rounded-md px-8 py-4 text-lg transition-all duration-300 shadow-lg"
                    style={{
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="text-white/80 hover:text-white font-medium text-lg transition-all duration-300 underline underline-offset-4 flex items-center gap-2"
                  style={{
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-white/70 font-medium">GateChain in Action</span>
              </motion.div>
              ...
              >
                <motion.span
                  ...
                  transition={{ duration: 4, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut", delay: 1 }}
                >
                  Accelerate your development with <span style={{ color: "#efb81c" }}>GateChain.</span>
                </motion.span>
              </motion.h2>
              ...
              >
                GateChain is the only L1 offering plug-and-play modules that can be customized and integrated into your
                app in seconds. Tap into world-class primitives and institutional-grade liquidity without starting from
                scratch.
              </motion.p>
              ...
              >
                {[
                  ...
                  "Zero-configuration blockchain integration",
              ...
              <div className="relative bg-gray-900/90 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700/50 bg-gray-800/50">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white/60 text-sm font-mono">gatechain-sdk.js</span>
                  </div>
                  <motion.button
              ...
              {[
                {
                  ...
                  description: "Complete reference for all GateChain APIs",
                  icon: "📚",
                  href: "#",
                },
                {
